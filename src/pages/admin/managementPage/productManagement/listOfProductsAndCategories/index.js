...
const ListOfProductsAndCategoriesPage  = () => {
  ...
  const initData = async () => {
    ...
    const fetchImagePromises = categoriesData.flatMap(category =>
                                                  ...
                                                  <div key={productIndex}>
                                                    <div className={`${selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY ? "product-field" : "search-product-field"}`}>
                                                      <div style={{display:"flex", justifyContent:"flex-start", alignItems:"center", width: "100%", height:"100%"}}>
                                                        ...
                                                        <a
                                                           style={{marginLeft:"15px", fontSize:"15", fontWeight:"600", color:"#9D9D9D", cursor:"default"}}
                                                        >
                                                          {product.productName}
                                                        </a>
                                                      </div>
  ...
  return (
      <div id="app">
        ...
        {addingCategory && (
            <div className="modal-overlay">
              <AddCategoryDialog onClose={() => {setAddingCategory(null)}}/>
            </div>
        )}
